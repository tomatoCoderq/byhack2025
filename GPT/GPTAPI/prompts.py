...
Сгенерируй:
npc_phrase_ru и npc_phrase_tt
final_text_ru и final_text_tt
story_ru и story_tt — связная история из 2–4 абзацев (по 2–4 коротких предложения в абзаце), отражающая начало, выбранные ветки, реплики NPC и последствия.

Правила тона:
tone=good — финал тёплый и радостный
tone=mixed — финал светлый с предостережением
